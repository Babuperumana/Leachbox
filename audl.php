...
function resetProgress() {
	...
	document.title = 'LeechBox - Auto Download';
}
/* ]]> */
</script>
<br /><br />
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Download Links</h3>
...
<table id="links" class="table table-hover">
	<thead>
		<tr><td><b><?php echo lang(21); ?></b></td><td><b><?php echo lang(22); ?></b></td></tr>
	</thead><tfoot>
		<tr id="auto"><td><br /><input class="btn btn-primary" type="button" value="<?php echo lang(29); ?>" onclick="javascript:startauto();" /></td></tr>
	</tfoot><tbody>
...
<div class="box">
<div class="box-body">
<iframe width="100%" height="300" src="" name="idownload" style="border:0"><?php echo lang(30); ?></iframe>
</div></div>

<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">Mehr Links</h3>
        <div class="box-tools pull-right">
          <button class="btn btn-box-tool" data-widget="collapse" ><i class="fa fa-minus"></i></button>
        </div>
    </div>
<div class="box-body" id="links">
	<textarea name="addlinks" id="addlinks" cols="60" rows="5"></textarea>
	<br /><br />
	<input type="button" class="btn btn-primary" value="<?php echo lang(31); ?>" onclick="javascript:addLinks();" />
</div></div>
...
<div class="box">
		<div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-download"></i> Download Links</h3>
              <div class="box-tools pull-right">
                <button class="btn btn-box-tool" data-widget="collapse" ><i class="fa fa-minus"></i></button>
              </div>
		</div>                       
	...
	<!-- /// Teaser 1 -->
	  <div id="teaser2">
		<div id="entered">
		<form role="form" action="?GO=GO" method="post" >
			<div id="listing" class="form-group">
				<textarea id="links" name="links" rows="25" cols="100" class="form-control"></textarea> </br>
				<input class="btn btn-primary" type="submit" value="<?php echo lang(34); ?>" onclick="javascript:HideAll();" style="width:100px;" />
			</div>
...
<?php } ?>
									...
									<tr>
										<td>
											...
											<div id="ytubeopt" style="display: none;">
												<div class="form-group">
												<div class="checkbox">
												<label>
													<input type="checkbox" name="cleanname" checked="checked" /><small>&nbsp;Remove non-supported characters from filename</small>
												</label>
												</div>
												</div>
												<div class="form-group">
														<select class="form-control" name="yt_fmt" id="yt_fmt">
